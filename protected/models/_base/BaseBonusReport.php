...
/**
 * This is the model base class for the table "bonus_report".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "BonusReport".
 *
 * Columns in table "bonus_report" available as properties of the model,
 * followed by relations of table "bonus_report" available as properties of the model.
 *
 * @property integer $id
 * @property string $dt
...
abstract class BaseBonusReport extends BaseGxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'BonusReport|BonusReports', $n);
	}
