...
class YiiMail extends CApplicationComponent
{
  ...
  */
  public function registerScripts() {
    ...
    $swift_dir=Yii::getPathOfAlias('application.vendors.swift').DIRECTORY_SEPARATOR;
    require $swift_dir.'classes'.DIRECTORY_SEPARATOR.'Swift.php';
    Yii::registerAutoloader(array('Swift','autoload'));
    require $swift_dir.'swift_init.php';
  }
