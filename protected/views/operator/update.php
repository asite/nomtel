...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'updateButtonUrl'=>'Yii::app()->controller->createUrl("tariff/update",array("id"=>$data->id))',
            'deleteButtonUrl'=>'Yii::app()->controller->createUrl("tariff/delete",array("id"=>$data->id))',
