Уважаемый клиент компании ООО "Номтел"!<br/>
Участились мошеннические случаи с номерами, по которым у нас нет данных абонента. Просим вас закрепить Ваш номер у представителей
нашей компании до 01.05.2013.

<div class="pOS_load_passport cfix" style="padding-bottom:10px;margin-top:10px;">
ВНИМАНИЕ: Регистрация обязательна всем абонентам. С 01.05.2013 номерам без данных про абонента будет отказано в помощи.
Восстановление номера, получение детализаций, подключение и отключение услуг, и другие сервисные услуги будут недоступны.
</div>
